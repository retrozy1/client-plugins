...
const wrapCalcMovementVelocity = api.rewriter.createShared("WrapCalcMovmentVel", (func) => {
    ...
    const h = (A, t) => {
        ...
        if (g !== A.physics.state.movement.direction && (B && 0 !== A.physics.state.movement.xVelocity && (A.physics.state.movement.xVelocity = 0), A.physics.state.movement.accelerationTicks = 0, A.physics.state.movement.direction = g), A.physics.state.movement.xVelocity !== l) {
            ...
            let t = 0,
                i = 0;
            A.physics.state.grounded ? B ? (t = GL.platformerPhysics.movement.ground.accelerationSpeed, i = GL.platformerPhysics.movement.ground.maxAccelerationSpeed) : t = GL.platformerPhysics.movement.ground.decelerationSpeed : B ? (t = GL.platformerPhysics.movement.air.accelerationSpeed, i = GL.platformerPhysics.movement.air.maxAccelerationSpeed) : t = GL.platformerPhysics.movement.air.decelerationSpeed;
